...
if __name__ == "__main__":
    ...
    y, tsteps = run_Ordmm_Land(parameters=params, num_beats=1000, lam=0.9, out='gomez_endo_coupled_iso_090.npy')

    params = get_init_param_coupled(hf_type='gomez', cell_type=0, lam=0.95, iso=1)
    y, tsteps = run_Ordmm_Land(parameters=params, num_beats=1000, lam=0.95, out='gomez_endo_coupled_iso_095.npy')

    params = get_init_param_coupled(hf_type='gomez', cell_type=0, lam=1, iso=1)
    y, tsteps = run_Ordmm_Land(parameters=params, num_beats=1000, lam=1, out='gomez_endo_coupled_iso_100.npy')

    params = get_init_param_coupled(hf_type='gomez', cell_type=0, lam=1.05, iso=1)
    y, tsteps = run_Ordmm_Land(parameters=params, num_beats=1000, lam=1.05, out='gomez_endo_coupled_iso_105.npy')

    params = get_init_param_coupled(hf_type='gomez', cell_type=0, lam=1.1, iso=1)
    y, tsteps = run_Ordmm_Land(parameters=params, num_beats=1000, lam=1.1, out='gomez_endo_coupled_iso_110.npy')
